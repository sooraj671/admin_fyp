...
// import 'package:file_upload_web/pages/OrderDetails.dart';
...
//   @override
//   State<EditOrderPage> createState() => _EditOrderPageState(order);
// }
...
//   _EditOrderPageState(this._order) {
//     myController[0].text = _order.price.toString();
//     myController[1].text = _order.quantity.toString();
//     //myController[2].text = _order.email;
